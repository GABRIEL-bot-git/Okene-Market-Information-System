                        ...
                        <table class="w-full text-left border-collapse">
                            ...
                            <tbody class="divide-y divide-gray-50 text-sm text-gray-600">
                                ...
                                <tr class="hover:bg-gray-50 transition-colors">
                                    ...
                                    <td class="py-3 px-6"><span class="bg-gray-100 text-gray-600 px-2 py-1 rounded text-xs"><?php echo htmlspecialchars($m['location']); ?></span></td>
                                    <td class="py-3 px-6 text-right">
                                        <a href="manage_markets.php?delete_id=<?php echo $m['id']; ?>" onclick="return confirm('Are you sure you want to delete this crop?');" class="text-red-500 hover:text-red-700 font-medium text-xs bg-red-50 px-3 py-1.5 rounded-lg">Delete</a>
                                    </td>
                                </tr>
                                <?php endforeach; ?>
                            </tbody>
